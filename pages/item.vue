		...
		<div class="content__top">
			<ul class="breadcrumbs">
				<li class="breadcrumbs__item">
					<NuxtLink to="/" class="breadcrumbs__link" href="index.html"> Каталог </NuxtLink>
				</li>
				<li class="breadcrumbs__item">
					<NuxtLink to="/" class="breadcrumbs__link" href="#"> Носки </NuxtLink>
				</li>
				<li class="breadcrumbs__item">
					<NuxtLink to="" class="breadcrumbs__link"> Носки с принтом мороженое </NuxtLink>
				</li>
			</ul>
		</div>
